...
export default function Home() {
  ...
  return (
    <>
      <div className="hero">
        <h1>Откройте мир<br />с <span>Noris Airlines</span></h1>
      ...
      <div className="search-card">
        ...
        <div className="search-fields">
          ...
          <div className="form-group" style={{ position: 'relative' }} ref={ddRef}>
            ...
            <button type="button" className="passenger-trigger" onClick={() => setShowPassengers(!showPassengers)}>
              <span>{total}</span>
              <span style={{ fontSize: 10 }}>{showPassengers ? '▲' : '▼'}</span>
            </button>
            {showPassengers && (
              <div className="passenger-menu">
                {[
                  ...
                  <div key={t.key} className="passenger-item">
                    <div>
                      <div className="passenger-item-label">{t.label}</div>
                      <div className="passenger-item-desc">{t.desc}</div>
                    </div>
